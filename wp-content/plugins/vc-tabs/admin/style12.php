                                        ...
                                        <div class="oxilab-tabs-content-div-50">
                                            <div class="oxilab-tabs-content-div">
                                                ...
                                                if (empty($styledata[81])) {
                                                    ...
                                                    echo VcTabsAdminTabsAnimation($styledata[81]);
                                                }
                                                if (empty($styledata[83])) {
                                                    echo VcTabsAdminTabsLink();
                                                } else {
                                                    echo VcTabsAdminTabsLink($styledata[83]);
                                                }
                                                ?>
                                            </div>
                                            <div class="oxilab-tabs-content-div">
                        ...
                        <script type="text/javascript">
                            jQuery(document).ready(function () {
                                ...
                                jQuery("#heading-background-active-color").on("change", function () {
                                    jQuery("<style type='text/css'>#oxilab-preview-data  .ctu-ultimate-wrapper-<?php echo $styleid; ?> .vc-tabs-li.active{ background-color:" + jQuery('#heading-background-active-color').val() + ";} </style>").appendTo(".ctu-ultimate-wrapper-<?php echo $styleid; ?>");
                                    jQuery("<style type='text/css'>#oxilab-preview-data  .ctu-ultimate-wrapper-<?php echo $styleid; ?> .vc-tabs-li.active .ctu-absolute{ border-left-color:" + jQuery('#heading-background-active-color').val() + ";} </style>").appendTo(".ctu-ultimate-wrapper-<?php echo $styleid; ?>");
                                });
                                ...
                                jQuery("#heading-text-align").on("change", function () {
                                    jQuery("<style type='text/css'>#oxilab-preview-data  .ctu-ulimate-style-<?php echo $styleid; ?> .vc-tabs-li{ text-align: " + jQuery('#heading-width').val() + ";} </style>").appendTo(".ctu-ultimate-wrapper-<?php echo $styleid; ?>");
                                });
                                jQuery("#heading-padding").on("change", function () {
                                    jQuery("<style type='text/css'>#oxilab-preview-data  .ctu-ultimate-wrapper-<?php echo $styleid; ?> .vc-tabs-li{ padding: " + jQuery('#heading-padding').val() + "px 10px;} </style>").appendTo(".ctu-ultimate-wrapper-<?php echo $styleid; ?>");
                                });
                                jQuery("#heading-margin-bottom").on("change", function () {
                                    jQuery("<style type='text/css'>#oxilab-preview-data  .ctu-ultimate-wrapper-<?php echo $styleid; ?> .vc-tabs-li{ margin-bottom: " + jQuery('#heading-margin-bottom').val() + "px;} </style>").appendTo(".ctu-ultimate-wrapper-<?php echo $styleid; ?>");
                                });
                                ...
                                jQuery("#content-border").on("change", function () {
                                    jQuery("<style type='text/css'>#oxilab-preview-data  .ctu-ulitate-style-<?php echo $styleid; ?>-tabs{ border:" + jQuery('#content-border').val() + "px solid;} </style>").appendTo(".ctu-ultimate-wrapper-<?php echo $styleid; ?>");
                                });
                                jQuery("#content-border-color").on("change", function () {
                                    jQuery("<style type='text/css'>#oxilab-preview-data  .ctu-ulitate-style-<?php echo $styleid; ?>-tabs{ border-color:" + jQuery('#content-border-color').val() + ";} </style>").appendTo(".ctu-ultimate-wrapper-<?php echo $styleid; ?>");
                                });
                                jQuery("#content-radius").on("change", function () {
                                    jQuery("<style type='text/css'>#oxilab-preview-data  .ctu-ulitate-style-<?php echo $styleid; ?>-tabs{ border-radius:" + jQuery('#content-radius').val() + "px;} </style>").appendTo(".ctu-ultimate-wrapper-<?php echo $styleid; ?>");
                                });
