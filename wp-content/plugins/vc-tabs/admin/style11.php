                                            ...
                                            <div class="oxilab-tabs-content-div">
                                                ...
                                                if (empty($styledata[69])) {
                                                 ...
                                                 if (empty($styledata[71])) {
                                                    ...
                                                    echo VcTabsAdminTabsAnimation($styledata[71]);
                                                }
                                                if (empty($styledata[73])) {
                                                    echo VcTabsAdminTabsLink();
                                                } else {
                                                    echo VcTabsAdminTabsLink($styledata[73]);
                                                }
                                                ?>
                                            </div>
                                            <div class="oxilab-tabs-content-div">
                        ...
                        <script type="text/javascript">
                            jQuery(document).ready(function () {
                                ...
                                jQuery("#heading-font-color").on("change", function () {
                                    jQuery("<style type='text/css'>#oxilab-preview-data  .ctu-ulimate-style-<?php echo $styleid; ?> .vc-tabs-li span{ color:" + jQuery('#heading-font-color').val() + ";} </style>").appendTo(".ctu-ultimate-wrapper-<?php echo $styleid; ?>");
                                });
                                ...
                                jQuery("#heading-icon-size").on("change", function () {
                                    jQuery("<style type='text/css'>#oxilab-preview-data  .ctu-ulimate-style-<?php echo $styleid; ?> .vc-tabs-li span .oxi-icons{ font-size: " + jQuery('#heading-icon-size').val() + "px;} </style>").appendTo(".ctu-ultimate-wrapper-<?php echo $styleid; ?>");
                                });
